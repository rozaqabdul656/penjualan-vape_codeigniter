                            ...
                            <form id="searchDate">
                                <div class="row">
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" placeholder="..." data-toggle="datepicker" name="dari" autocomplete="off" class="form-control dari date">
                                    </div>
                                    <div class="col-md-2">
                                        <label for="">Ke Tanggal</label>
                                        <input type="text" placeholder="..." data-toggle="datepicker" name="ke" autocomplete="off" class="form-control ke date">
                                    </div>
    ...
    $(document).ready(function() {
        ...
        <?php if ($this->uri->segment(3)) : ?>
            $(document).on('click', '.btnSearch', function() {
                $.ajax({
                    url: "<?= $user['role_id'] == 1 ? base_url('superadmin/search_history_percabang/' . $this->uri->segment(3)) : base_url('admin/search_history_percabang') ?>",
                    type: "POST",
