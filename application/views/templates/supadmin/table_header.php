...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/') ?>css/style_print.css" media="print">
    <link rel="stylesheet" href="<?= base_url('assets/') ?>css/components.css">
    <link rel="stylesheet" href="<?= base_url('assets/') ?>css/jquery-ui-me.css">

</head>

<?php if (isset($sidebar_mini)) : ?>
