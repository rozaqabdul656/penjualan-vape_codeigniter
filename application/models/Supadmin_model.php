...
class Supadmin_model extends CI_Model
{
  ...
  public function sam_isi_tampil_checkout()
  {
    ...
    <div id="didie"></div>
      ...
      <p class="text-danger mb-0">**Tekan (F10) untuk menampilkan barang </p>
  ...
  public function sam_search_history_pengeluaran()
  {
    ...
    $output .= '
        ...
        $this->session->set_userdata('darihistorypengeluaran',$dari);
        $this->session->set_userdata('kehistorypengeluaran',$ke);
  ...
  public function sam_search_history()
  {
    ...
    $output .= '
        ...
        $this->session->set_userdata('darihistorypen',$dari);
        $this->session->set_userdata('kehistorypen',$ke);
  ...
  public function sam_data_jual_bulan()
  {
    ...
    $output .= '
        ...
        ';
        $this->session->set_userdata('bulanpenjualan','');
        $this->session->set_userdata('tahunpenjualan','');
  ...
  public function sam_data_pengeluaran_hari()
  {
    ...
    ';        $ke=$this->session->set_userdata('kepengeluaranhari','');
        $dari=$this->session->set_userdata('daripengeluaranhari','');
  ...
  public function sam_data_pengeluaran_bulan()
  {
    ...
    $output .= '
        ...
        $this->session->set_userdata('bulanpengeluaran','');
        $this->session->set_userdata('tahunpengeluaran','');   
    return $output;
  }
  ...
  public function sam_search_data_pengeluaran_bulan()
  {
    ...
    $output .= '
        ...
        $this->session->set_userdata('bulanpengeluaran',$bulan);
        $this->session->set_userdata('tahunpengeluaran',$tahun);
